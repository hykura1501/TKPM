...
import { Faculty, Student} from "@/types/student"
...
export const getCourseByCode = (courseCode: string, courses: Course[]): Course | undefined => {
  return courses.find((course) => course.code === courseCode)
}

// Helper function to get student by ID
export const getStudentById = (studentId: string, students: Student[]): Student | undefined => {
  return students.find((student) => student.mssv === studentId)
}

// Helper function to get class section by ID
export const getClassSectionById = (sectionId: string, classSections: ClassSection[]): ClassSection | undefined => {
